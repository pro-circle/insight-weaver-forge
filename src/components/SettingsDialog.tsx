...
export function SettingsDialog({ userId, onSaved }: { userId: string; onSaved: () => void }) {
  ...
  async function save() {
    ...
    if (f.smtp_user && !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(f.smtp_user))
      return toast.error("Gmail address looks invalid");
    setBusy(true);
          ...
          <div className="space-y-4 pt-2">
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Country auto-detected · max 10 local digits.
              </p>
            </div>
              ...
              <div className="mt-3 grid grid-cols-2 gap-3">
                ...
                <div className="col-span-1">
                  ...
                  <Input
                    ...
                    type="number"
                    value={f.smtp_port}
                    onChange={(e) => setF({ ...f, smtp_port: Number(e.target.value) || 465 })}
                  />
                </div>
              </div>
              <div className="mt-3">
                ...
                <Input
                  ...
                  type="email"
                  value={f.smtp_user}
                  onChange={(e) => setF({ ...f, smtp_user: e.target.value })}
